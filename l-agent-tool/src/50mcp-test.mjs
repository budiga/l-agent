...
const mcpClient = new MultiServerMCPClient({
  mcpServers: {
    "l-mcp-server": {
      command: "node",
      args: ["/Users/liuxuehuan/Desktop/l-agent/l-agent-tool/src/40my-mcp-server.mjs"],
    },
...
// await runAgentWithTools("帮我查询北京南站附近的5家酒店，以及去的路线")
// await runAgentWithTools(
//   "北京南站附近的5个酒店，以及去的路线，路线规划生成文档保存到 /Users/liuxuehuan/Desktop 的一个 md 文件",
// )
await runAgentWithTools(
